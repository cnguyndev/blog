<x-layout-app>
    <x-slot:title>Kết quả tìm kiếm: {{ $query ?? '' }}</x-slot:title>
        ...
        <div class="flex flex-col lg:flex-row lg:gap-8">
            <div class="w-full lg:w-3/4 mb-8 lg:mb-0">
                <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-8 text-center lg:text-left">
                    Kết quả tìm kiếm: <span class="text-blue-600">"{{ $query ?? '' }}"</span>
                </h1>
                ...
                @else
                    <p class="col-span-full text-center text-gray-600">Không tìm thấy bài viết nào với từ khóa
                        "{{ $query ?? '' }}".</p>
                @endif
            </div>
