<x-layout-app>
    <x-slot:title>Tất cả bài viết</x-slot:title>
        ...
        <div class="flex flex-col lg:flex-row lg:gap-8">
            <div class="w-full lg:w-3/4 mb-8 lg:mb-0">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="bg-white rounded-xl shadow-md overflow-hidden">
                            ...
                            <div class="p-6">
                                ...
                                <a href="{{ route('site.post.detail', ['slug' => $post->slug]) }}"
                                    class="block text-xl font-semibold text-blue-gray-900 mb-2 normal-case transition-colors hover:text-gray-900">
                                    {{ $post->title }}
                                </a>
                    ...
                    @empty
                        <p class="col-span-full text-center text-gray-600">Chưa có bài viết nào được tìm thấy.</p>
                    @endforelse
                </div>
