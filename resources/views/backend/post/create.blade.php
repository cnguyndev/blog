<x-layout-admin>
    <x-slot:title>Tạo Bài viết mới</x-slot:title>

    <div class="card bg-white shadow-sm rounded-lg border border-gray-200 p-6">
        <h6 class="text-2xl font-bold mb-4 text-gray-800">Tạo Bài viết mới</h6>
        ...
        <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <select name="status" id="status"
                    ...
                    required>
                    <option value="1" {{ old('status', 1) == 1 ? 'selected' : '' }}>Đã xuất bản</option>
